...
<div class="col-sm-2 bg-dark p-0">
    ...
    <ul class="navbar-nav text-center me-auto">
        <li class="nav-item bg-warning">
            <a href="#" class="nav-link text-dark fw-bold"><h4  style="padding:18px;">Available Brands</h4></a>
</li><br>
<?php
getbrands();
...
<!-- fourth child -->
   ...
   <img class='card-img-top' src='./images/briyani1.jpg' class='card-img-top' alt='$product_title'>
   <div class='card-body'>
...
<img src='./images/briyani2.jpg' style="width:300px;height:250px;" class='carg-img-top'>
</div>
<div  class="col-md-6 mt-5">
<img src='./images/briyani3.jpg'  style="width:300px;height:250px;" class='carg-img-top'>
