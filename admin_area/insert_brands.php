...
<form action="" method="post" classs="mb-2">
<div class="input-groups w-90 mb-2">
<span class="input-groups-text bg-info" id="basic-addon1"><i class="fa-solid fa-receipt"></i></span>
...
<div class="input-groups w-10 mb-2 m-auto">
