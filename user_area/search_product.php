...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <ul class="navbar-nav me-auto">
    <li class="nav-item" style="margin-left:20px;">
        <a href="#" style="color:white;" class="nav-link">Welcome <?php //echo $_SESSION_['username'] ?></a>
</li>
<?php
...
<div class="container-fluid bg-dark p-3 footer text-center text-light fw-bold mt-3 p-0 footer">
