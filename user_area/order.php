...
//geting total items and total price of all items
...
$insert_orders="Insert into orders(user_id,amount_due,invoice_number,count_products,order_date,order_status)
...
$insert_pending_orders="Insert into orders_pending(user_id,invoice_number,count_products,quantity,order_status)
values('$user_id','$invoice_number','$count_products',$quantity,'$status')";
