...
function getproducts()
{
  global $con;
   ...
   if(!isset($_GET['category']))
   {
    if(!isset($_GET['brand']))
    {
   $select_query="Select * from `products` order by rand() LIMIT 0,70";
   ...
   while($row=mysqli_fetch_assoc($result_query))
   {
     ...
     $brand_id=$row['brand_id'];
      ...
      echo  "
     <div class='col-md-4 mb-5' class='image1 card'>
     <div class='card bg-light border-0 card' style='width: 18rem;'>
...
if($num_of_rows==0)
{
  echo "<h2 class='text-center text-danger'>No stock for this category</h2>";
   ...
   height:200px;
   object-fit:contain;
   padding:10px;' border-0' src='./admin_area/product_images/$product_image1' class='card-img-top' alt='$product_title'><br>
   <div class='card-body'>
   <h5 class='card-title fw-bold text-center'>$product_title</h5><br>
   <p class='card-text'>$product_description</p><br>
   <p class='card-text fw-bold text-center text-danger' style='font-size:20px;'><small class='text-dark'>Price :</small> &#8377;$product_price.00/- <small class='text-success fw-bold'>(10% off)</small></p>
...
function getbrands()
{
  ...
  while($row_data=mysqli_fetch_assoc($result_brands))
  {
    ...
    <a href='index.php?brand=$brand_id' class='nav-link text-light fw-bold' style='font-size:18px;'>$brand_title</a>
    </li><br>";
  }
...
while($row_data=mysqli_fetch_assoc($result_categories))
{
  ...
  echo "<li class='nav-item'>
  <a href='index.php?category=$category_id' class='nav-link text-light fw-bold' style='font-size:18px;'>$category_title</a>
  </li><br>";
}
}
...
<div class='row'>
    <div class='col-md-12'>
<h4 class='text-center fw-bold text-success'>Related products</h4>

</div>
<div  class='col-md-6 mt-5'>
<img src='./admin_area/product_images/$product_image2' style='width:300px;height:250px;object-fit:contain' class='carg-img-top'>
</div>
<div  class='col-md-6 mt-5'>
<img src='./admin_area/product_images/$product_image3'  style='width:300px;height:250px;object-fit:contain' class='carg-img-top'>
